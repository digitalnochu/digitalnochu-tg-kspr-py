    ...
    if command_base == "/mint":
        ...
        for i in bot_indices:
            if 1 <= i <= 10:
                ...
                # Send the base command first (e.g., /mint)
        ...
        # Sequentially send each argument (e.g., 'kaspi', '100', '1.6')
    ...
    try:
        if account_choice == "all":
            for account in accounts:
                await process_account(account, command_base, command_args, effective_range)
        else:
            ...
            while True:
                ...
                while True:
                    ...
                    if command_base == "/mint":
                        ...
                        # Execute the mint command with parsed values
